...
@Service
public class RestTemplateFindOne {

    private final RestTemplate restTemplate;
    
    private static String lastTimeStr = "";
    private static final String FIXED_SUFFIX = "123455";
    private static final DateTimeFormatter DATE_FMT = DateTimeFormatter.ofPattern("yyyyMMdd");
    private static final DateTimeFormatter TIME_FMT = DateTimeFormatter.ofPattern("HHmmss");

    public RestTemplateFindOne() {
    ...
    /** 예금(입출금) 계좌 목록 조회(단건) */
 // com.example.demo.findOneAccount.RestTemplateFindOne
    public String findDepositProduct(String userKey, String accountNo) {
        ...
        body.put("accountNo", accountNo); // ★ 입력한 계좌번호 사용
