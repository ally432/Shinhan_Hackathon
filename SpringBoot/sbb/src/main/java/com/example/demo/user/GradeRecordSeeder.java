...
public class GradeRecordSeeder {
	...
	private static final Map<String, Map<String, Double>> FIXED_GPA = Map.ofEntries(
			...
			// 목표(4.3,3.7) → (4.28,3.70) // 2학기만 달성
			entry("mintnova90@naver.com", Map.of("2025-1", 4.28, "2024-2", 3.70)),
			// 목표(4.0,4.3) → (4.00,4.28) // 1학기만 달성
			entry("nightowl710@hanmail.net", Map.of("2025-1", 4.00, "2024-2", 4.28)),
