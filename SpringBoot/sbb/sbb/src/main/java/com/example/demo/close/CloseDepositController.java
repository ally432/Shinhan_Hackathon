...
@CrossOrigin(origins = "*")
public class CloseDepositController {

    private final RestTemplateClose restTemplateDeposit;

    @GetMapping(value = "/deposit/closeDeposit", produces = MediaType.APPLICATION_JSON_VALUE)
