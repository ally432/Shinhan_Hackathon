...
@CrossOrigin(origins = "*")
public class DetailDepositController {

    private final RestTemplateDetailsDeposit restTemplateDeposit;

    @GetMapping(value = "/deposit/detailsDeposit", produces = MediaType.APPLICATION_JSON_VALUE)
