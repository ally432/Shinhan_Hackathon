package com.example.demo.details.deposit;
...
@Service
public class RestTemplateDetailsDeposit {
    ...
    public RestTemplateDetailsDeposit() {
    ...
    public String findDepositProduct(String userKey, String accountNo) {
        final String url = "https://finopenapi.ssafy.io/ssafy/api/v1/edu/deposit/inquireDepositPayment";
        InstIds ids = nextInstIds();

        Map<String, Object> Header = new LinkedHashMap<>();
        Header.put("apiName", "inquireDepositPayment");   // ✅ URL과 일치
        Header.put("transmissionDate", ids.date());
        Header.put("transmissionTime", ids.time());
        Header.put("institutionCode", INSTITUTION_CODE);
        Header.put("fintechAppNo", "001");
        Header.put("apiServiceCode", "inquireDepositPayment"); // ✅ 일치
