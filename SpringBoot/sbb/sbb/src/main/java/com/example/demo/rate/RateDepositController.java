...
@CrossOrigin(origins = "*")
public class RateDepositController {

    private final RestTemplateRate restTemplateDeposit;

    @GetMapping(value = "/deposit/rate", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<String> find(@RequestBody FindReq req) {
        log.info("[POST /deposit/rate] req={}", req);
